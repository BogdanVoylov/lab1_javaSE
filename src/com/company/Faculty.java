...
public class Faculty {
    ...
    public Student[] getStudentObjectsFromCathedraByYear(int cathedra, int year) {
        return cathedras[cathedra].getStudentObjectsByYear(year);
    }
    ...
    public Teacher[] getTeachers() {
        Teacher[] res = new Teacher[0];
        for (Cathedra cathedra : cathedras) {
            Object[] combination = Resizer.combine(res, cathedra.getTeachers());
            res = Arrays.copyOf(combination, combination.length, Teacher[].class);
        }
        return res;
    }

    public Student[] getStudentsOfCathedra(int cathedraIndex) {
        return cathedras[cathedraIndex].getStudents();
    }
    ...
    public Teacher[] getTeachersOfCathedra(int cathedraIndex) {
        return cathedras[cathedraIndex].getTeachers();
    }
}
